...
// Change Color Navbar Elements on Scroll
   ...
   $(window).scroll(function(){
    if ($(this).scrollTop() > 350) {
       ...
       $('.navbar-brand img').attr('src', asset-data-url("colorlogo.png"));
    } else {
...
$(function(){
    $(window).scroll(function(){
        if($(this).scrollTop() > 100) {
            ...
            $('.logo img')
                .attr('src',asset-data-url("colorlogo.png"));
        }
        if($(this).scrollTop() < 100) {
...
function myFunction() {
      ...
      text = "Please enter a valid Session Code";
         ...
         window.location.href = "https://drive.google.com/file/d/132JQ9viunuKXWTB6_fcf9Uh9Aa65rrVD/view?usp=sharing";
